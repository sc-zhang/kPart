...
```shell
usage: kPart.py [-h] -r REFERENCE -b BAM [-k KMER] [-w WORKDIR] [-t THREADS] [-v]

options:
  -h, --help            show this help message and exit
  -r, --reference REFERENCE
                        reference contig fasta
  -b, --bam BAM         directory of bam files, contain at least two sorted and indexed bam which were generated by mapping reads from parents to reference contigs
  -k, --kmer KMER       size of kmer, default=21
  -w, --workdir WORKDIR
