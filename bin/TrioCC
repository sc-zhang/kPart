...
def get_opts():
	...
	group.add_argument('-b', '--bam', help='directory of bam files, contain two sorted and indexed bam which were generated by mapping reads from parents to reference contig', required=True)
	group.add_argument('-k', '--kmer', help='size of kmer, default=21', type=int, default=21)
	group.add_argument('-w', '--workdir', help='directory for temp files and result files, default=\"workdir\"', default='workdir')
